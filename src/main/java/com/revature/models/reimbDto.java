...
//	public int reim_numb;
	...
	public reimbDto(int id, double amt, String description, int rAuthorId, int rResolverId,
			String rStatus, String rType) {
		super();
		this.id = id;
		this.amt = amt;
	...
	public reimbDto(double amt, String description, int rAuthorId, int rResolverId, String rStatus,
			String rType) {
		super();
		this.amt = amt;
		this.description = description;
	...
	public String toString() {
		return "reimbDto [id=" + id + ", amt=" + amt + ", description=" + description + ", rAuthorId=" + rAuthorId
				+ ", rResolverId=" + rResolverId + ", rStatus=" + rStatus + ", rType=" + rType + "]";
	}
